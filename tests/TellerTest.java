...
public class TellerTest {
	...
	public void setUp()  throws Exception {
		...
		DepositMoneyHandler depositMoneyRequest = new DepositMoneyHandler(accounts, money, display);
		classUnderTest = new Teller(openAccountRequest,withdrawMoneyRequest, depositMoneyRequest);
